...
public class UserInterface {
    ...
    public void displayUI() {
        System.out.print("""
                ...
                """);
        System.out.print("Name for the Order?: ┗(▀̿Ĺ̯▀̿ ̿)┓");
    ...
    public void addSandwich() {
        ...
        while (!isRunning) {
            ...
            switch (sizeChoice) {
                ...
                case 3:
                    size = 12;
                    System.out.println("Okay! Big Back");
                    System.out.println();
                    break;
                case 4:
                    return;
    ...
    public void addDrink() {
        ...
        while (!isRunning) {
            ...
            System.out.println("""
                    ...
                    | ██  ██ ████▀ ████▀   ████▀  ██ ██ ██ ██ ▀██ ██ ██\s |
                    |====================================================|
                    |          Choose a Size (S: 2.00, M: 2.50, L: 3.00) |
                    |----------------------------------------------------|
                    |1.                      Small                       |
                    |----------------------------------------------------|
                    |2.                      Medium                      |
       ...
       //While the menu is running prompt this to the user
        while (!isRunning){
            ...
            System.out.println("""
                   ...
                   | ██  ██ ████▀ ████▀   ▀█████ ██ ██ ██ ██    ▄▄██▀\s|
                   |==================================================|
                   |1.                  Kettle Jalapeno ($1.50)       |
                   |--------------------------------------------------|
                   |2.                      BBQ ($1.50)               |
                   |--------------------------------------------------|
                   |3.                Ruffles' Hot BBQ ($1.50)        |
                   |--------------------------------------------------|
                   |4.                     Funyuns  ($1.50)           |
                   |--------------------------------------------------|
                   |5.                   Hot Fries ($1.50)            |
    ...
    public void addMeat(){
        ...
        while(!isRunning){
            System.out.println("""
                    ...
                    | ██   ██ ██▄▄▄  ▀█▀█▀    █████▀ ██▀██ ██ ▀██ ████▀ ▀███▀\s  |
                    |===========================================================|
                    |         Choose your meat     (S: 1.00, M: 2.00, L:3.00)   |
                    |===========================================================|
                    |1.                          Steak                          |
                    |-----------------------------------------------------------|
                    |2.                           Ham                           |
            ...
            System.out.println("""
                    ...
                    | ██   ██ ██▄▄▄  ▀█▀█▀    █████▀ ██▀██ ██ ▀██ ████▀ ▀███▀\s  |
                    |===========================================================|
                    |   Would you like Extra Meat?  (S: .50, M: 1.00 L: 1.50)   |
                    |===========================================================|
                    |1.                            Yes                          |
                    |-----------------------------------------------------------|
                    |2.                            No                           |
    ...
    //Null check to prevent it from crashing.
        ...
        while(!isRunning){
            ...
            System.out.println("""
                    ...
                    | ██   ██ ██▄▄▄  ▀█▀█▀    █████▀ ██▀██ ██ ▀██ ████▀ ▀███▀\s  |
                    |===========================================================|
                    |         Choose your Cheese   (S: .75, M: 1.50 L: 2.25)    |
                    |===========================================================|
                    |1.                          American                       |
                    |-----------------------------------------------------------|
                    |2.                          Provolone                      |
            ...
            System.out.println("""
                    ...
                    | ██   ██ ██▄▄▄  ▀█▀█▀    █████▀ ██▀██ ██ ▀██ ████▀ ▀███▀\s  |
                    |===========================================================|
                    |   Would you like Extra Cheese? (S: .30, M: .60 L: 0.90)   |
                    |===========================================================|
                    |1.                            Yes                          |
                    |-----------------------------------------------------------|
                    |2.                            No                           |
    ...
    public void checkOut() {
            ...
            if (userInput.equalsIgnoreCase("Y")) {
                ...
                System.out.println("Order Saved!  ☚(ﾟヮﾟ☚)");
                return;
            }
